...
module.exports = {
  ...
  run: async (client, message) => {
    ...
    let channelsToDelete = ["log-join-leave", "log-ban-unban", "log-kick", "log-messages", "log-pic", "log-roles", "log-links", "log-nickname", "log-channels", "log-vjoin-vexit", "log-move", "log-tmute-untmute", "log-bots", "log-prison-unprison", "log-warns"];
